...
- Interface inicial com formulário de abertura de chamado
- API REST com rotas para cadastro e listagem
...
- Dashboard com atualização automática em tempo real (refresh a cada 10–15 segundos)
- Configuração de notificações automáticas por e-mail
- Melhorar as estatísticas dos chamados, incluindo gráficos, histórico detalhado e análises por período
