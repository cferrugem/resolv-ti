...
class QueryBuilder {
  ...
  async _run() {
    try {
      const response = await fetch(`${API_URL}/api/mock/query`, {
        method: 'POST',
...
export const supabase = {
  ...
  async rpc(fnName, params) {
    ...
    try {
      const response = await fetch(`${API_URL}/api/mock/rpc/${fnName}`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  auth: {
    ...
    async getUser(token) {
      ...
      try {
        const response = await fetch(`${API_URL}/api/mock/auth/getUser`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    async signInWithPassword({ email, password }) {
      try {
        const response = await fetch(`${API_URL}/api/mock/auth/signIn`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
    ...
    async signUp({ email, password }) {
      try {
        const response = await fetch(`${API_URL}/api/mock/auth/signUp`, {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({ email, password })
        });
